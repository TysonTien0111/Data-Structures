...
int main () {
    ...
    // Recursive Delete Test for empty BST
    bst.recursive_delete(40, bst.get_root(), nullptr);
    ...
    bst.recursive_insert(8, bst.get_root());
    bst.recursive_insert(100, bst.get_root());
    bst.recursive_insert(90, bst.get_root());
    bst.recursive_insert(120, bst.get_root());


    // Recursive Insertion Test for duplicate values
    bst.recursive_insert(15, bst.get_root());

    // Recursive Delete Test for nonexistent value in BST
    bst.recursive_delete(40, bst.get_root(), nullptr);

    // Recursive Delete Test for no child
    bst.recursive_delete(5, bst.get_root(), nullptr);
    bst.recursive_delete(120, bst.get_root(), nullptr);
    
    // Recursive Delete Test for one child
    bst.recursive_delete(7, bst.get_root(), nullptr);
    bst.recursive_delete(100, bst.get_root(), nullptr);
    
    // Recursive Delete Test for two children
    bst.recursive_delete(15, bst.get_root(), nullptr);
    bst.recursive_delete(6, bst.get_root(), nullptr);
    
    // For Recursive Delete Test node #4
    bst.recursive_insert(5, bst.get_root());
    bst.recursive_insert(6, bst.get_root());
        
    bst.recursive_delete(4, bst.get_root(), nullptr); // Still a Recursive Delete Test for two children
    
    // Recursive Delete Test, deleting the whole tree
    bst.recursive_delete(15, bst.get_root(), nullptr); 
    bst.recursive_delete(6, bst.get_root(), nullptr);

    // For Recursive Delete Test node #23
    bst.recursive_insert(51, bst.get_root());

    bst.recursive_delete(23, bst.get_root(), nullptr); // Still a Recursive Delete Test for two children

    bst.recursive_delete(4, bst.get_root(), nullptr);
    bst.recursive_delete(7, bst.get_root(), nullptr);
    bst.recursive_delete(5, bst.get_root(), nullptr);
    bst.recursive_delete(71, bst.get_root(), nullptr);
    bst.recursive_delete(50, bst.get_root(), nullptr);
    bst.recursive_delete(3, bst.get_root(), nullptr);
    bst.recursive_delete(8, bst.get_root(), nullptr);
    bst.recursive_delete(100, bst.get_root(), nullptr);
    bst.recursive_delete(90, bst.get_root(), nullptr);
    bst.recursive_delete(120, bst.get_root(), nullptr);
    bst.recursive_delete(51, bst.get_root(), nullptr);
